...
function checkNull(e, r, t) {
    var a = $("#" + e).val().trim();
    return "" == a || a == t ? ($("#error_" + e).length > 0 ? $("#error_" + e).html(r) : $("#" + e).after('<div class="nameformError parentFormfrm_contact formError"><div id="error_' + e + '" class="formErrorContent">' + r + "</div></div>"), !1) : !0
}

function checkPhone(e, r, t) {
    var a = $("#" + e).val().trim();
    return "" == a || a == t || a.length < 10 || a.length > 11 ? ($("#error_" + e).length > 0 ? $("#error_" + e).html(r) : $("#" + e).after('<div class="nameformError parentFormfrm_contact formError"><div id="error_' + e + '" class="formErrorContent">' + r + "</div></div>"), !1) : !0
}

function checkMail(e, r) {
    return checkEmail(e) ? !0 : ($("#error_" + e).length > 0 ? $("#error_" + e).html(r) : $("#" + e).after('<div class="nameformError parentFormfrm_contact formError" ><div id="error_' + e + '" class="formErrorContent">' + r + "</div></div>"), !1)
}

function checkCaptcha(e, r) {
    var t = $("#" + e).val().trim(),
        a = $("#" + e + "_bk").val().trim();
    return t != a ? ($("#error_" + e).length > 0 ? $("#error_" + e).html(r) : $("#" + e).after('<div class="nameformError parentFormfrm_contact formError" ><div id="error_' + e + '" class="formErrorContent">' + r + "</div></div>"), !1) : !0
}

function checkNullTwo(e, r, t, a, o) {
    var i = $("#" + e).val().trim(),
        n = $("#" + r).val().trim();
    return "" == i || i == a || "" == n || n == o ? ($("#error_" + e).length > 0 ? $("#error_" + e).html(t) : $("#" + e).after('<div class="nameformError parentFormfrm_contact formError" ><div id="error_' + e + '" class="formErrorContent">' + t + "</div></div>"), !1) : !0
}

function checkSelect(e, r, t) {
    var a = $("#" + e).val();
    return "" == a || a == t || 0 == a ? ($("#error_" + e).length > 0 ? $("#error_" + e).html(r) : $("#" + e).after('<div class="nameformError parentFormfrm_contact formError"><div id="error_' + e + '" class="formErrorContent">' + r + "</div></div>"), !1) : !0
}

function checkComment(e, r, t) {
    var a = $("#" + e).val().trim();
    return !$("#other-check:checked").length || "" != a && a != t ? !0 : ($("#error_" + e).length > 0 ? $("#error_" + e).html(r) : $("#" + e).after('<div class="nameformError parentFormfrm_contact formError"><div id="error_' + e + '" class="formErrorContent">' + r + "</div></div>"), !1)
}

function checkNhucau(e, r) {
    return $("#other-check:checked").length || $("." + e + ":checked").length ? !0 : ($("#error_" + e).length > 0 ? $("#error_" + e).html(r) : $("." + e + ":first").after('<div class="nameformError parentFormfrm_contact formError"><div id="error_' + e + '" class="formErrorContent">' + r + "</div></div>"), !1)
}

function checkCheckbox(e, r) {
    return $("." + e + ":checked").length ? !0 : ($("#error_" + e).length > 0 ? $("#error_" + e).html(r) : $("." + e + ":first").after('<div class="nameformError parentFormfrm_contact formError"><div id="error_' + e + '" class="formErrorContent">' + r + "</div></div>"), !1)
}

function checkQuocTich(e, r) {
    return $("." + e + ":checked").length ? !0 : ($("#error_" + e).length > 0 ? $("#error_" + e).html(r) : $("." + e + ":first").parent().after('<div class="nameformError parentFormfrm_contact formError"><div id="error_' + e + '" class="formErrorContent">' + r + "</div></div>"), !1)
}

function checkCMND(e, r, t) {
    var a = $("#" + e).val().trim();
    return "" == a || a == t || 9 != a.length && 12 != a.length ? ($("#error_" + e).length > 0 ? $("#error_" + e).html(r) : $("#" + e).after('<div class="nameformError parentFormfrm_contact formError"><div id="error_' + e + '" class="formErrorContent">' + r + "</div></div>"), !1) : !0
}

function checkPassport(e, r, t) {
    var a = $("#" + e).val().trim();
    return "" == a || a == t || a.length > 12 ? ($("#error_" + e).length > 0 ? $("#error_" + e).html(r) : $("#" + e).after('<div class="nameformError parentFormfrm_contact formError"><div id="error_' + e + '" class="formErrorContent">' + r + "</div></div>"), !1) : !0
}
...
function checkDate(e, r, t, a, o, i) {
    ...
    return "" == n || n == t ? ($("#error_" + e).length > 0 ? $("#error_" + e).html(r) : $("#" + e).after('<div class="nameformError parentFormfrm_contact formError"><div id="error_' + e + '" class="formErrorContent">' + r + "</div></div>"), !1) : c > u ? ($("#error_" + e).length > 0 ? $("#error_" + e).html(i) : $("#" + e).after('<div class="nameformError parentFormfrm_contact formError"><div id="error_' + e + '" class="formErrorContent">' + i + "</div></div>"), !1) : !0
}
...
function validateregister() {
    ...
    var r = {
        init: function(t) {
            var a = this;
            return a.data("jqv") && null != a.data("jqv") || (t = r._saveOptions(a, t), e(".formError").live("click", function() {
        ...
        attach: function(t) {
            ...
            return a.binded || ("bind" == a.bindMethod ? (o.find("[class*=validate]").not("[type=checkbox]").not("[type=radio]").not(".datepicker").bind(a.validationEventTrigger, r._onFieldEvent), o.find("[class*=validate][type=checkbox],[class*=validate][type=radio]").bind("click", r._onFieldEvent), o.find("[class*=validate][class*=datepicker]").bind(a.validationEventTrigger, {
                delay: 300
            }, r._onFieldEvent), o.bind("submit", r._onSubmitEvent)) : "live" == a.bindMethod && (o.find("[class*=validate]").not("[type=checkbox]").not(".datepicker").live(a.validationEventTrigger, r._onFieldEvent), o.find("[class*=validate][type=checkbox]").live("click", r._onFieldEvent), o.find("[class*=validate][class*=datepicker]").live(a.validationEventTrigger, {
                delay: 300
            }, r._onFieldEvent), o.live("submit", r._onSubmitEvent)), a.binded = !0, a.autoPositionUpdate && e(window).bind("resize", {
                noAnimation: !0,
                formElem: o
            }, r.updatePromptsPosition)), this
        },
        detach: function() {
            var t = this,
                a = t.data("jqv");
            return a.binded && (t.find("[class*=validate]").not("[type=checkbox]").unbind(a.validationEventTrigger, r._onFieldEvent), t.find("[class*=validate][type=checkbox],[class*=validate][type=radio]").unbind("click", r._onFieldEvent), t.unbind("submit", r.onAjaxFormComplete), t.find("[class*=validate]").not("[type=checkbox]").die(a.validationEventTrigger, r._onFieldEvent), t.find("[class*=validate][type=checkbox]").die("click", r._onFieldEvent), t.die("submit", r.onAjaxFormComplete), t.removeData("jqv"), a.autoPositionUpdate && e(window).unbind("resize", r.updatePromptsPosition)), this
        },
        validate: function() {
        ...
        updatePromptsPosition: function(t) {
            if (t && this == window) var a = t.data.formElem,
        ...
        hide: function() {
            var t;
            return t = e(this).is("form") ? "parentForm" + r._getClassName(e(this).attr("id")) : r._getClassName(e(this).attr("id")) + "formError", e("." + t).fadeTo("fast", .3, function() {
                e(this).parent(".formErrorOuter").remove(), e(this).remove()
            }), this
        },
        hideAll: function() {
        ...
        _validateField: function(t, a, o) {
            ...
            f || "" != t.val() || (a.isError = !1);
            var x = t.prop("type");
            ("radio" == x || "checkbox" == x) && m.find("input[name='" + c + "']").size() > 1 && (t = e(m.find("input[name='" + c + "'][type!=hidden]:first")), a.showArrow = !1), "text" == x && m.find("input[name='" + c + "']").size() > 1 && (t = e(m.find("input[name='" + c + "'][type!=hidden]:first")), a.showArrow = !1), a.isError ? r._showPrompt(t, u, "", !1, a) : d || r._closePrompt(t), d || t.trigger("jqv.field.result", [t, a.isError, u]);
        ...
        _creditCard: function(e, r, t, a) {
            ...
            if (n >= 14 && 16 >= n && parseInt(i) > 0) {
                var l, s = 0,
                    ...
                    d = 1,
                    c = new String;
                do l = parseInt(i.charAt(t)), c += d++ % 2 == 0 ? 2 * l : l; while (--t >= 0);
        ...
        _buildPrompt: function(t, a, o, i, n) {
            ...
            return l.css({
                ...
                opacity: 0
            }).data("callerField", t), n.autoHidePrompt ? (setTimeout(function() {
                l.animate({
                    opacity: 0
                }, function() {
        ...
        _updatePrompt: function(e, t, a, o, i, n, l) {
            if (t) {
                "undefined" != typeof o && ("pass" == o ? t.addClass("greenPopup") : t.removeClass("greenPopup"), "load" == o ? t.addClass("blackPopup") : t.removeClass("blackPopup")), i ? t.addClass("ajaxed") : t.removeClass("ajaxed"), t.find(".formErrorContent").html(a);
        ...
        _calculatePosition: function(e, t, a) {
            ...
            var u = e.data("promptPosition") || a.promptPosition,
                ...
                v = 0,
                p = 0;
            if ("string" == typeof u && -1 != u.indexOf(":") && (f = u.substring(u.indexOf(":") + 1), u = u.substring(0, u.indexOf(":")), -1 != f.indexOf(",") && (m = f.substring(f.indexOf(",") + 1), f = f.substring(0, f.indexOf(",")), p = parseInt(m), isNaN(p) && (p = 0)), v = parseInt(f), isNaN(f) && (f = 0)), r.isRTL(e)) switch (u) {
                default:
                case "topLeft":
    ...
    e.fn.validationEngine = function(t) {
        var a = e(this);
        return a[0] ? "string" == typeof t && "_" != t.charAt(0) && r[t] ? ("showPrompt" != t && "hidePrompt" != t && "hide" != t && "hideAll" != t && r.init.apply(a), r[t].apply(a, Array.prototype.slice.call(arguments, 1))) : "object" != typeof t && t ? void e.error("Method " + t + " does not exist in jQuery.validationEngine") : (r.init.apply(a, arguments), r.attach.apply(a)) : !1
    }, e.validationEngine = {
        defaults: {
...
}(jQuery), eval(function(e, r, t, a, o, i) {
    if (o = function(e) {
